...
/*
This version did pass the tests. However, it uses one arraylist called workset,
and not the other arraylist called changed. Initialization seems like a big deal
in this code as far as time of execution is concerned.
*/

public class FS_Ver6{
