...
/*
Everything flattened. No functions. Just one function called query 
that does the job. It passed once with 116s but then, the subsequent
submissions failed. Looks like they make it more complicated with subsequent 
submissions if it passed the last time with narrow margin.
*/

public class FriendSuggestion_Efficient_Ver7{
