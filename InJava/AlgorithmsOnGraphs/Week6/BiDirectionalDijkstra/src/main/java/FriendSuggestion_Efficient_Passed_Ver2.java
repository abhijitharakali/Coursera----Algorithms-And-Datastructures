...
/*
This is same as the previous passed code. However, I changed workset
to a Hashset from an Arraylist. Time, however, did not improve by much.
*/

public class FriendSuggestion_Efficient_Passed_Ver2{
    
    public static int n;
    public static int m;
    public static long[] df, dr;
    public static boolean[] visited;
    public static HashSet<Integer> workset,wf,wr;
