...
/*
Just added a few more lines of code which are important. Basically, the 
nodes in wr and wf should not be relaxed as it is known that they are
already the shortest distances.
*/

public class FriendSuggestion_Efficient_Ver8{
