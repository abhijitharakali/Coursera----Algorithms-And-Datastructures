import java.util.*;
/*
I tried to implement my own map thinking it might reduce time but it didn't!
It went up to 160s!
*/
public class FriendSuggestion_Efficient_Ver5{
    
    public static long inf = Long.MAX_VALUE / 4;

    public static class Dmap {
        HashSet<Integer> keys = new HashSet<>();
        long[] distances = new long[1000000];
        int k;
        long d;
