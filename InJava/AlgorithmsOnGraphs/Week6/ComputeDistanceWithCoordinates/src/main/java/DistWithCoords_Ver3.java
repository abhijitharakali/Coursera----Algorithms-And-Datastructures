...
/*
Same as previous version except that instead of using workset to find the 
ubest, I kept separate arraylists wf, and wr, to find the ubest in the
shortestdistance function.
*/

public class DistWithCoords_Ver3{
    ...
    public static ArrayList<Integer> workset,wf,wr;
